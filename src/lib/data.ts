...
// Get a guest by ID
export async function getGuest(guestId: string): Promise<Guest | undefined> {
  try {
...
// Get song suggestions by guest ID
export async function getSongSuggestionsByGuest(guestId: string): Promise<SongSuggestion[]> {
  try {
